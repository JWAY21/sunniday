            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                Group {
                    Text("Age")
                        .font(.system(size: 13, weight: .bold))
                        .foregroundColor(.white.opacity(0.85))
                    InfoText("Modelled as full capacity to age 20, then declining 1.5% a year to a floor of 25% at age 70. Applied only when you have set a birth year in Settings, the gear at the top left. Leave it unset and no age adjustment is made.\n\nThis one is contested, see limitations.")
                }
            }
        }
    }
